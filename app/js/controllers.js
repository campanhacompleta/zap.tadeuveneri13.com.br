...
angular.module('myApp.controllers', ['myApp.i18n'])
    ...
    function saveAuth (result) {
      ...
      setTimeout(function(){
          ...
          var modalHello = $modal.open({
            templateUrl: templateUrl('redelivre_welcome_modal'),
  ...
  .controller('AppIMController', function ($q, qSync, $scope, $location, $routeParams, $modal, $rootScope, $modalStack, MtpApiManager, AppUsersManager, AppChatsManager, AppMessagesManager, AppPeersManager, ContactsSelectService, ChangelogNotifyService, ErrorService, AppRuntimeManager, HttpsMigrateService, LayoutSwitchService, LocationParamsService, AppStickersManager) {
    ...
    // // redelibre welcome modal, use essa parte para testar
    // var modalHello = $modal.open({
    //   templateUrl: templateUrl('redelivre_welcome_modal'),
    //   controller: 'RedelivreWelcomeModalControler',
    //   windowClass: 'redelivre_welcome_modal_window mobile_modal',
  ...
  .controller('RedelivreWelcomeModalControler', function ($scope, $rootScope, $location, $timeout, $modal, $modalStack, MtpApiManager, ErrorService, NotificationsManager, ChangelogNotifyService, IdleManager, LayoutSwitchService, TelegramMeWebService, _) {
